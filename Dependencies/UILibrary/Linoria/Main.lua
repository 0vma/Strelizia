...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        SatVibMap.InputBegan:Connect(function(Input)
            if (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInfoType == Enum.UserInfoType.Touch) then
                while (InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) or InputService:IsMouseButtonPressed(Enum.UserInfoType.Touch)) do
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        PickOuter.InputBegan:Connect(function(Input)
            if (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInfoType == Enum.UserInfoType.Touch) and not Library:MouseIsOverOpenedFrame() then
                Picking = true;
...
do
    ...
    function Funcs:AddLabel(Text, DoesWrap, Properties)
        ...
        if DoesWrap then
            local Y = select(2, Library:GetTextBounds(removeColorTags(Text), Library.Font, 14, Vector2.new(TextLabel.AbsoluteSize.X, math.huge)))
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        Slider.MaxSize = SliderInner.AbsoluteSize.X - 2
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local function RecalculateListSize(YSize, Scrolling)

            --ListOuter.Size = UDim2.fromOffset((not Calculated and DropdownOuter.AbsoluteSize.X or Calculated), YSize or (MAX_DROPDOWN_ITEMS * 20 + 2))
            ListOuter.Size = (Scrolling and UDim2.fromOffset(DropdownOuter.AbsoluteSize.X + Scrolling.X.Offset, YSize) or UDim2.new(0, DropdownOuter.AbsoluteSize.X, 0, (YSize or (MAX_DROPDOWN_ITEMS * 20 + 2))))
        end;
        ...
        function Dropdown:BuildDropdownList()
            ...
            for Idx, Value in next, Values do
                ...
                if ButtonLabel.TextBounds.X > LargestX then
                    LargestX = ButtonLabel.TextBounds.X
                end
            ...
            local Calculated = UDim2.new(Scrolling.Size.X.Scale, (LargestX > Scrolling.AbsoluteSize.X and (LargestX + 20 - Scrolling.AbsoluteSize.X) or Scrolling.Size.X.Offset), Scrolling.Size.Y.Scale, Scrolling.Size.Y.Offset)

            Scrolling.CanvasSize = UDim2.fromOffset(0, (Count * 20) + 1);
            --Scrolling.Size = Calculated
            ListOuter.Size = Calculated --UDim2.fromOffset(Scrolling.UIListLayout.AbsoluteContentSize.X + 1, Scrolling.UIListLayout.AbsoluteContentSize.Y + 1)
            --DropdownInner.Size = UDim2.fromOffset(Scrolling.UIListLayout.AbsoluteContentSize.X, Scrolling.UIListLayout.AbsoluteContentSize.Y)
            local Y = math.clamp(Count * 20, 0, MAX_DROPDOWN_ITEMS * 20) + 1;
            RecalculateListSize(Y, Calculated);
        end;
...
function Library:CreateWindow(...)
    ...
    function Window:AddTab(Name)
        ...
        local LeftSide = Library:Create('ScrollingFrame', {
            ...
            Size = UDim2.new(0.5, -12 + 2, 0, TabFrame.AbsoluteSize.Y - 15);
            CanvasSize = UDim2.new(0, 0, 0, 0);
            BottomImage = '';
            TopImage = '';
            ScrollBarThickness = 0;
    ...
    function Library:Toggle()
        ...
        for _, Desc in next, Inner:GetDescendants() do
            local Properties = {};
