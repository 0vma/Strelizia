...
local Success, Return = pcall(function()
    return loadstring(game:HttpGet(string.format(MainTree, string.format("Games/%s", game.PlaceId..(getgenv()._debug and "debug.lua" or getgenv()._testbuild and "test.lua" or ".lua"))), true))
end)
